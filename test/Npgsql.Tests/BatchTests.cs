...
namespace Npgsql.Tests
{
    ...
    public class BatchTests : MultiplexingTestBase
    {
        ...
        public async Task RecordsAffected_and_Rows()
        {
            ...
            Assert.That(command.LongRows, Is.EqualTo(2));
            ...
            Assert.That(command.LongRows, Is.EqualTo(1));
            ...
            Assert.That(command.LongRows, Is.EqualTo(0));
        ...
        public async Task SingleRow()
        {
            ...
            await using var reader = await batch.ExecuteReaderAsync(CommandBehavior.SingleRow);
            Assert.That(reader.Read(), Is.True);
            Assert.That(reader.GetInt32(0), Is.EqualTo(1));
        ...
        public async Task SchemaOnly_GetFieldType()
        {
            ...
            await using var reader = await batch.ExecuteReaderAsync(CommandBehavior.SchemaOnly);
        ...
        public async Task CloseConnection()
        {
            ...
            await using (var reader = await batch.ExecuteReaderAsync(CommandBehavior.CloseConnection))
                while (reader.Read()) {}
