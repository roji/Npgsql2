...
#pragma warning restore CA1010
    {
        ...
        public override int RecordsAffected
            => !_recordsAffected.HasValue
                ? -1
                : ULongRecordsAffected > int.MaxValue
                    ? throw new OverflowException(
                        $"The number of records affected exceeds int.MaxValue. Use {nameof(ULongRecordsAffected)}.")
                    : (int)ULongRecordsAffected;

        /// <summary>
        /// Gets the number of rows changed, inserted, or deleted by execution of the SQL statement.
        /// </summary>
        public ulong ULongRecordsAffected { get; internal set; }
