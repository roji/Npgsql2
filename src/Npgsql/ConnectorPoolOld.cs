...
namespace Npgsql
{
    ...
    /// </summary>
    sealed class ConnectorPoolOld : IDisposable
    {
        ...
        internal ConnectorPoolOld(NpgsqlConnectionStringBuilder settings, string connString)
        {
        ...
        {
            var pool = (ConnectorPoolOld)state!;
