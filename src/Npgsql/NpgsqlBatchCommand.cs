...
namespace Npgsql
{
    public sealed class NpgsqlBatchCommand : DbBatchCommand
    {
        ...
        /// </remarks>
        // TODO: Possibly make ulong and kill LongRows
        ...
        public override int RecordsAffected
        {
            get
            {
                ...
                case StatementType.Delete:
                    return LongRows > int.MaxValue
                        ? throw new OverflowException($"The number of records affected exceeds int.MaxValue. Use {nameof(LongRows)}.")
                        : (int)LongRows;
                default:
                    return -1;
                }
